...
def run_hhsearch(a3m_file, cpu_no):
    """
    Run HHSearch to produce the hhr file
    """
    cmd = ['/data/hh-suite/bin/hhsearch',
           '-i', a3m_file, '-cpu', cpu_no, '-d',
           '/data/pdb70/pdb70']
...
def run_s4pred(input_file, out_file):
    ...
    """
    cmd = ['/usr/bin/python3', '/data/s4pred/run_model.py',
...
if __name__ == "__main__":
    ...
    for k, v in sequences.items():
        ...
        run_hhsearch(a3m_file, sys.argv[2])
        run_parser(hhr_file)
